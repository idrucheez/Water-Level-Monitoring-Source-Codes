...
<table align="left" width="100%" style="border-collapse: collapse; border: none;">
  <tr>
    ...
    <td width="36%" valign="top" style="padding: 0 4px 0 0; border: none;">
      <details open>
    ...
    <td width="64%" valign="top" style="padding: 0 0 0 4px; border: none;">
      <div style="background: #0d1117; border: 1px solid #30363d; border-radius: 4px; padding: 4px; text-align: center;">
        <strong style="color: #58a6ff; font-size: 9px; display: block; margin-bottom: 4px;">Wiring & Power Schematic</strong>
        <a href="docs/diagrams/Circuit%20Diagram.jpg" target="_blank">
          <img src="docs/diagrams/Circuit%20Diagram.jpg" alt="Schematic" width="100%" style="border-radius: 4px; border: 1px solid #21262d; cursor: pointer;">
        </a>
        <p style="color: #8b949e; font-size: 9px; margin: 4px 0 0 0; line-height: 1.3;">
